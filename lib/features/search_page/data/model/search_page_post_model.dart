...
class PostModel extends Post {
  ...
  factory PostModel.fromJson(Map<String, dynamic> json) => PostModel(
      ...
      photoUrl:
          '${ApiConstants.photoImageUrl}/${json["server"]}/${json["id"]}_${json["secret"]}_${SizeSuffix.small_400}.jpg');
  ...
  factory PostModel.fromMap(Map<String, dynamic> map) => PostModel(
      ...
      photoUrl:
          '${ApiConstants.photoImageUrl}/${map["server"]}/${map["id"]}_${map["secret"]}_${SizeSuffix.small_400}.jpg');
